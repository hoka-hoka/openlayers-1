...
declare class ImageTile extends Tile {
     ...
     * @param {any} image
     */
    constructor(tileCoord: import("./tilecoord.js").TileCoord, state: any, src: string, crossOrigin: string | null, tileLoadFunction: import("./Tile.js").LoadFunction, options: import("./Tile.js").Options, image: any);
    /**
     * @private
     * @type {?string}
     */
